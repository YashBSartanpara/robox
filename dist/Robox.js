    ...
    _createClass(WrappedComponent, [{
      ...
      value: function render() {
        ...
        var _props = this.props,
            ...
            order = _props.order,
            style = _props.style,
            compRef = _props.compRef,
            props = _objectWithoutProperties(_props, ['p', 'pt', 'pr', 'pb', 'pl', 'px', 'py', 'm', 'mt', 'mr', 'mb', 'ml', 'mx', 'my', 'gutter', 'col', 'block', 'inlineBlock', 'inline', 'table', 'tableRow', 'tableCell', 'flex', 'inlineFlex', 'wrap', 'flexColumn', 'align', 'justify', 'flexAuto', 'flexNone', 'order', 'style', 'compRef']);
        ...
        return _react2.default.createElement(Comp, _extends({ ref: compRef }, props, { style: sx }));
      }
    }]);
